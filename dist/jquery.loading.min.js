  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      const r = function(t, e) {
        (this.element = t),
          (this.settings = o.a.extend({}, r.defaults, e)),
        ...
        o.a.extend(r.prototype, {
          ...
          attachMethodsToExternalEvents: function() {
            ...
            t.element.on("loading.start", function() {
              t.overlay
                .removeClass(t.settings.hiddenClass)
                .addClass(t.settings.shownClass);
            }),
              t.element.on("loading.stop", function() {
                t.overlay
                  .removeClass(t.settings.shownClass)
                  .addClass(t.settings.hiddenClass);
              }),
              t.settings.stoppable &&
          ...
          calcZIndex: function() {
            return void 0 !== this.settings.zIndex
        ...
        return this.each(function() {
          ...
          e
            ? void 0 === t
              ...
              : "string" == typeof t
              ? e[t].apply(e)
              : (e.destroy(), o.a.data(this, s, new r(o()(this), t)))
            : (void 0 !== t &&
                "object" != typeof t &&
                "start" !== t &&
                "toggle" !== t) ||
              o.a.data(this, s, new r(o()(this), t));
        });
      }),
        (o.a.fn.Loading = function(t) {
          var e = o()(this).data(s);
          return (
            (e && void 0 === t) || o()(this).data(s, (e = new r(o()(this), t))),
            e
          );
        }),
